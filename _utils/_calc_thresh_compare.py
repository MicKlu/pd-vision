...
with open(f"_calc_tresh_results_easy_samples_{img_file}.csv", "r") as f:
    with open(f"_calc_thresh_compare_out/_calc_tresh_results_easy_samples_{img_file}_compared.csv", "w") as fout:
        ...
        while True:
            ...
            a = ReferenceAlgorithm(f"../imgs/easy_samples/{img_file}", s_thresh, v_thresh)
            a.count()
            ...
            if save:
                ...
                cv.imwrite(f"_calc_thresh_compare_out/{s_thresh},{v_thresh}_{img_file}.png", a.img_morphed)
