...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.safeZoneLabel = QtWidgets.QLabel(self.customAlgorithmTab)
        self.safeZoneLabel.setObjectName("safeZoneLabel")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.safeZoneLabel)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.safeZoneSlider = QtWidgets.QSlider(self.customAlgorithmTab)
        self.safeZoneSlider.setMaximum(10000)
        self.safeZoneSlider.setSingleStep(10)
        self.safeZoneSlider.setPageStep(100)
        self.safeZoneSlider.setProperty("value", 8000)
        self.safeZoneSlider.setOrientation(QtCore.Qt.Horizontal)
        self.safeZoneSlider.setObjectName("safeZoneSlider")
        self.horizontalLayout_4.addWidget(self.safeZoneSlider)
        self.safeZoneSpin = QtWidgets.QDoubleSpinBox(self.customAlgorithmTab)
        self.safeZoneSpin.setMinimumSize(QtCore.QSize(86, 0))
        self.safeZoneSpin.setMaximum(100.0)
        self.safeZoneSpin.setProperty("value", 80.0)
        self.safeZoneSpin.setObjectName("safeZoneSpin")
        self.horizontalLayout_4.addWidget(self.safeZoneSpin)
        ...
        self.imageComboRight.setCurrentIndex(11)
        ...
        MainWindow.setTabOrder(self.customMinSizeSpin, self.safeZoneSlider)
        MainWindow.setTabOrder(self.safeZoneSlider, self.safeZoneSpin)
        MainWindow.setTabOrder(self.safeZoneSpin, self.algorithmCombo)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.imageComboLeft.setItemText(8, _translate("MainWindow", "Operacje morfologiczne (przestrzeń S)"))
        self.imageComboLeft.setItemText(9, _translate("MainWindow", "Operacje morfologiczne (przestrzeń V)"))
        self.imageComboLeft.setItemText(10, _translate("MainWindow", "Operacje morfologiczne"))
        self.imageComboLeft.setItemText(11, _translate("MainWindow", "Zliczanie"))
        self.imageComboRight.setCurrentText(_translate("MainWindow", "Zliczanie"))
        ...
        self.imageComboRight.setItemText(8, _translate("MainWindow", "Operacje morfologiczne (przestrzeń S)"))
        self.imageComboRight.setItemText(9, _translate("MainWindow", "Operacje morfologiczne (przestrzeń V)"))
        self.imageComboRight.setItemText(10, _translate("MainWindow", "Operacje morfologiczne"))
        self.imageComboRight.setItemText(11, _translate("MainWindow", "Zliczanie"))
        ...
        self.safeZoneLabel.setText(_translate("MainWindow", "Strefa bezpieczna"))
        ...
        self.actionSave.setToolTip(_translate("MainWindow", "Zapisz obraz"))
