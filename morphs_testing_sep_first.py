...
if __name__ == "__main__":
    ...
    # big morphed
    img_big_morphed = cv.bitwise_or(img_s_morphed_big, img_v_morphed_big)

    # small morphed
    img_small_morphed = cv.bitwise_and(img_s_morphed_small, img_v_morphed_small)

    img_sv_morphed_and = cv.bitwise_and(img_small_morphed, img_big_morphed)
    img_sv_morphed_or = cv.bitwise_or(img_small_morphed, img_big_morphed)
